 ...
 * @method static void buildClient()
 * @method static void createClient(void $handlerStack)
 * @method static void buildHandlerStack()
 * @method static void pushHandlers(void $handlerStack)
